  ...
  return (
    <div className="min-h-screen bg-secondary/30">
      ...
      <main className="pt-20 lg:pt-[70px]">
        {/* Hero Banner */}
        <div className="relative h-48 md:h-64 bg-gradient-to-r from-slate-800 to-slate-600 overflow-hidden">
          <div className="absolute inset-0 bg-black/30" />
          <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
            <div className="text-center text-white">
              <h1 className="text-3xl md:text-5xl font-bold font-heading mb-2">Western Wear</h1>
              <p className="text-lg md:text-xl opacity-90 font-body">Contemporary styles for the modern woman</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-background border-b border-border">
          <div className="container mx-auto px-4 py-3">
            <nav className="flex items-center gap-2 text-sm font-body">
              ...
              <span className="text-foreground font-medium">Western Wear</span>
            </nav>
          </div>
        </div>
            ...
            <div className="flex-1">
              {isLoading ? (
                ...
                <div className="text-center py-20 bg-background rounded-lg">
                  <p className="text-muted-foreground text-lg mb-4 font-body">No western wear products found</p>
